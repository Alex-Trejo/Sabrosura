...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'LogInMaps',
          path: '/logInMaps',
          builder: (context, params) => const LogInMapsWidget(),
        ),
        FFRoute(
          name: 'homePage',
          path: '/homePage',
        ...
        FFRoute(
          name: 'pagAlmuerzos',
          path: '/pagAlmuerzos',
          builder: (context, params) => const PagAlmuerzosWidget(),
        ),
        FFRoute(
          name: 'Producto',
          path: '/producto',
          builder: (context, params) => const ProductoWidget(),
        ),
        FFRoute(
          name: 'MetPago',
          path: '/metPago',
          builder: (context, params) => const MetPagoWidget(),
        ),
        FFRoute(
          name: 'Perfil_cliente',
          path: '/perfilCliente',
        ...
        FFRoute(
          name: 'AdmUsuario',
          path: '/admUsuario',
          builder: (context, params) => const AdmUsuarioWidget(),
        )
