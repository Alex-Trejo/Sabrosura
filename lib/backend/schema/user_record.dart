...
class UserRecord extends FirestoreRecord {
  ...
  // "isMotorizado" field.
  bool? _isMotorizado;
  bool get isMotorizado => _isMotorizado ?? false;
  bool hasIsMotorizado() => _isMotorizado != null;
  ...
  void _initializeFields() {
    ...
    _isMotorizado = snapshotData['isMotorizado'] as bool?;
  }
...
class UserRecordDocumentEquality implements Equality<UserRecord> {
  ...
  bool equals(UserRecord? e1, UserRecord? e2) {
    return e1?.email == e2?.email &&
        ...
        e1?.isMotorizado == e2?.isMotorizado;
  }
